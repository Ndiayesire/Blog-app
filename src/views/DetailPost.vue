...
<template>
  <div class="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative" style="height: 24em;">
    ...
    <img src="https://images.seneweb.com/dynamic/modules/news/images/gen/fb/7081a6cf0ad90864a303fa199c3f7fc42f80b09d.jpeg" class="absolute rounded-lg left-0 top-0 w-full h-full z-0 object-cover" />
  ...
  <!-- <div class="max-w-screen-md mx-auto pt-8 "><div class="flex space-x-2 border-2 bg-gray-100 rounded-md"><i class="ri-chat-1-line text-xl ml-3"></i><p class="font-bold text-underline">Liste des commentaires</p></div><p v-for="(comment, index) in state.comments" :key="index" class="pt-2">{{ comment }}</p></div> -->
  ...
  <!-- Display comments from the array with a deletion icon -->
